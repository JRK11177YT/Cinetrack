...
-- =============================================
-- MIGRACIÓN DE DATOS REALES (v0.5.0)
-- Propósito: Inyectar nombres de archivos UUID reales en las semillas
-- =============================================

-- 1. Limpiar catálogo actual para reinserción límpia (esto ayuda a que las IDs empiecen de 1 si auto_increment permite)
DELETE FROM peliculas;
ALTER TABLE peliculas AUTO_INCREMENT = 1;

-- 2. Reinserción con URLs reales de archivos existentes en app/uploads/
-- Nota: Se han mapeado los archivos UUID listados en el sistema de archivos a las películas del catálogo original.
...
-- GÉNERO: COMEDIA (4) / THRILLER (5) / AVENTURA (6)
INSERT INTO peliculas (titulo, descripcion, duracion, anio, url_imagen, url_video, genero_id, destacada) VALUES
...
('Pulp Fiction', 'Las vidas de varios criminales de Los Ángeles se entrelazan en tres historias violentas y surrealistas que mezclan humor negro, filosofía y situaciones extremas.', 154, 1994, 'ba2b6f7f-1bc0-4644-8506-4be36d43164c.jpg', NULL, 5, FALSE),
